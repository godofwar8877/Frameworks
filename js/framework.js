...
var col3_4 = document.getElementById("col3_4");
var col3_5 = document.getElementById("col3_5");
var col3_6 = document.getElementById("col3_6");
...
var col5_1 = document.getElementById("col5_1");
var col6_1 = document.getElementById("col6_1");
var col7_1 = document.getElementById("col7_1");
...
function materialize(){
    ...
    col3_1.className = "col s12 m50 l3";
    ...
    nav_mobile.className = "down hide-on-med-and-down";
...
function foundation(){
    ...
    contenedor.className = paddingRight;
    ...
    nav1.className = "top-bar-right";
    nav_id.className = "top-bar-right";
    logo.className = "menu-text right";
